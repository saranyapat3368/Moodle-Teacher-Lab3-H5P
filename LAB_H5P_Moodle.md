...
**รหัสใบงาน**: LAB-H5P-DEV-01  
**วิชา**: การพัฒนาระบบการจัดการเรียนรู้ / เทคโนโลยีการพัฒนาซอฟต์แวร์  
**ระดับ**: ปริญญาตรี / ประกาศนียบัตรวิชาชีพชั้นสูง  
**เวลา**: 5 ชั่วโมง (แบ่งเป็น 2 คาบ)

---

## 🎯 วัตถุประสงค์

1. สร้างสื่อการสอนแบบโต้ตอบด้วย H5P ครอบคลุม 12 ประเภทบน Moodle
2. นำเสนอแนวคิด DevOps ผ่านรูปแบบสื่อที่เหมาะสมกับเนื้อหา
3. ออกแบบ Branching Scenario จำลองสถานการณ์แก้ปัญหา CI/CD จริง
4. เชื่อมต่อ H5P Activity กับ Moodle Gradebook อย่างถูกต้อง
...
```
วาดโครงสร้างด้วย draw.io หรือ Canva แล้ว Export เป็น PNG:
